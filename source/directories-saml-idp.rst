.. _directories-saml-idp:

********************************************
Appendix: SAML (Identity Provider Initiated)
********************************************

This section will show you how to set-up Stormpath to allow your users to log in with a SAML-enabled Identity Provider (IdP) via the Identity Provider Initiated flow.
